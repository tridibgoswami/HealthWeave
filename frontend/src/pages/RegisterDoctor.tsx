...
const SPECIALIZATIONS = [
  "General Physician", "Cardiologist", "Neurologist", "Orthopedician",
  "Gastroenterologist", "Endocrinologist", "Pulmonologist", "Nephrologist",
  "Oncologist", "Dermatologist", "Psychiatrist", "Gynecologist",
  "Pediatrician", "Ophthalmologist", "ENT Specialist", "Other",
];
